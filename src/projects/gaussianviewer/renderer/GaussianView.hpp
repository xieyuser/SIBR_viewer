...
namespace sibr
{
	...
	public:
		 ...
		 * \param render_w rendering widthknnmapBuffer
	...
	protected:
		...
		float *fallbackNormalBufferCuda = nullptr;
		float *fallbackSegBufferCuda = nullptr;
		float *fallbackKnnmapBufferCuda = nullptr;
